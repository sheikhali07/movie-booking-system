              ...
              <div class="row">
                <div class="col-12 col-sm-7">
                  <div class="d-flex align-items-center gap-3 mb-5">
                    ...
                    <div class="">
                      <p class="mb-0 fw-semibold">Welcome back Admin </p>
                  ...
                  <div class="d-flex align-items-center gap-5">
                    <div class="d-flex align-items-center gap-4">
                      ...
                      // Fetch today's sales
                      $result = $conn->query("SELECT SUM(total_amount) AS today_sales FROM bookings WHERE DATE(created_at)='$today'");
                      $row = $result->fetch_assoc();
                      $todaySales = $row['today_sales'] ?? 0;

                      // Fetch yesterday's sales
                      $yesterday = date('Y-m-d', strtotime('-1 day'));
                      $result = $conn->query("SELECT SUM(total_amount) AS yesterday_sales FROM bookings WHERE DATE(created_at)='$yesterday'");
                      $row = $result->fetch_assoc();
                      ...
                      <div class="flex-fill">
                        ...
                        <p class="mb-3">Today's Booking</p>
